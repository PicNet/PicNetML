...
namespace Ml2.Arff.Builder
{
  internal class InstancesBuilder<T> : IInstancesBuilder<T> where T : new()
  {
    ...
    private List<Ml2Attribute> attributes;
    ...
    private void CacheAttributeIndexes(List<Ml2Attribute> atts) {
    ...
    private Ml2Instance CreateInstanceForRow(T row)
    { 
      ...
      return new Ml2Instance(impl);
    }

    private double GetValue(Ml2Attribute att, object v)
    {
