...
namespace Ml2.Fltr
{
  public class FiltersUnsupervisedAttribute
  {
    private readonly Runtime rt;    
    public FiltersUnsupervisedAttribute(Runtime rt) { this.rt = rt; }   
    ...
    /// ignore.<br/>
    /// </summary>
    public AddCluster AddCluster { get {
      return new AddCluster(rt); 
    } }
    ...
    /// </summary>
    public AddExpression AddExpression { get {
      return new AddExpression(rt); 
    } }
    ...
    /// </summary>
    public AddNoise AddNoise { get {
      return new AddNoise(rt); 
    } }
    ...
    /// </summary>
    public AddUserFields AddUserFields { get {
      return new AddUserFields(rt); 
    } }
    ...
    /// </summary>
    public AddValues AddValues { get {
      return new AddValues(rt); 
    } }
    ...
    /// </summary>
    public ChangeDateFormat ChangeDateFormat { get {
      return new ChangeDateFormat(rt); 
    } }
    ...
    /// </summary>
    public ClassAssigner ClassAssigner { get {
      return new ClassAssigner(rt); 
    } }
    ...
    /// </summary>
    public ClusterMembership ClusterMembership { get {
      return new ClusterMembership(rt); 
    } }
    ...
    /// </summary>
    public FirstOrder FirstOrder { get {
      return new FirstOrder(rt); 
    } }
    ...
    /// off)
    /// </summary>
    public InterquartileRange InterquartileRange { get {
      return new InterquartileRange(rt); 
    } }
    ...
    /// </summary>
    public KernelFilter KernelFilter { get {
      return new KernelFilter(rt); 
    } }
    ...
    /// </summary>
    public MakeIndicator MakeIndicator { get {
      return new MakeIndicator(rt); 
    } }
    ...
    /// 1,2)
    /// </summary>
    public MergeManyValues MergeManyValues { get {
      return new MergeManyValues(rt); 
    } }
    ...
    /// </summary>
    public MergeTwoValues MergeTwoValues { get {
      return new MergeTwoValues(rt); 
    } }
    ...
    /// </summary>
    public NominalToString NominalToString { get {
      return new NominalToString(rt); 
    } }
    ...
    /// </summary>
    public NumericCleaner NumericCleaner { get {
      return new NumericCleaner(rt); 
    } }
    ...
    /// data.<br/>	(default: no)
    /// </summary>
    public NumericToBinary NumericToBinary { get {
      return new NumericToBinary(rt); 
    } }
    ...
    /// indexes.<br/>	(default: first-last)<br/>-V = 	Invert matching sense of column indexes.
    /// </summary>
    public NumericToNominal NumericToNominal { get {
      return new NumericToNominal(rt); 
    } }
    ...
    /// (default abs)
    /// </summary>
    public NumericTransform NumericTransform { get {
      return new NumericTransform(rt); 
    } }
    ...
    /// </summary>
    public Obfuscate Obfuscate { get {
      return new Obfuscate(rt); 
    } }
    ...
    /// </summary>
    public PKIDiscretize PKIDiscretize { get {
      return new PKIDiscretize(rt); 
    } }
    ...
    /// </summary>
    public PartitionedMultiFilter PartitionedMultiFilter { get {
      return new PartitionedMultiFilter(rt); 
    } }
    ...
    /// matrix (default 42).
    /// </summary>
    public RandomProjection RandomProjection { get {
      return new RandomProjection(rt); 
    } }
    ...
    /// </summary>
    public RandomSubset RandomSubset { get {
      return new RandomSubset(rt); 
    } }
    ...
    /// </summary>
    public RemoveByName RemoveByName { get {
      return new RemoveByName(rt); 
    } }
    ...
    /// </summary>
    public RemoveUseless RemoveUseless { get {
      return new RemoveUseless(rt); 
    } }
    ...
    /// </summary>
    public Reorder Reorder { get {
      return new Reorder(rt); 
    } }
    ...
    /// </summary>
    public ReplaceMissingValues ReplaceMissingValues { get {
      return new ReplaceMissingValues(rt); 
    } }
    ...
    /// is<br/>	applied to the data.<br/>	(default: no)
    /// </summary>
    public ReplaceMissingWithUserConstant ReplaceMissingWithUserConstant { get {
      return new ReplaceMissingWithUserConstant(rt); 
    } }
    ...
    /// </summary>
    public SortLabels SortLabels { get {
      return new SortLabels(rt); 
    } }
    ...
    /// </summary>
    public Standardize Standardize { get {
      return new Standardize(rt); 
    } }
    ...
    /// </summary>
    public StringToNominal StringToNominal { get {
      return new StringToNominal(rt); 
    } }
    ...
    /// </summary>
    public StringToWordVector StringToWordVector { get {
      return new StringToWordVector(rt); 
    } }
    ...
    /// </summary>
    public SwapValues SwapValues { get {
      return new SwapValues(rt); 
    } }
    ...
    /// use missing values).
    /// </summary>
    public TimeSeriesDelta TimeSeriesDelta { get {
      return new TimeSeriesDelta(rt); 
    } }
    ...
    /// </summary>
    public TimeSeriesTranslate TimeSeriesTranslate { get {
      return new TimeSeriesTranslate(rt); 
    } }
