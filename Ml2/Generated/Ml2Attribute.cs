...
namespace Ml2
{
  public partial class Ml2Attribute  : IEnumerable<string>
  {
  
    /// <summary>
    /// This is used to create a new Runtime with a specified set of Instances.
    /// </summary>
    public Ml2Attribute(Attribute impl) { Impl = impl; }
    ...
    public static string TypeToString(Ml2Attribute att) { return Attribute.typeToString(att.Impl); }
    ...
    public static string TypeToStringShort(Ml2Attribute att) { return Attribute.typeToStringShort(att.Impl); }
    ...
    public int AddStringValue(Ml2Attribute src, int index) { return Impl.addStringValue(src.Impl, index); }
    public int AddRelation(Runtime value) { return Impl.addRelation(value.Impl); }
    public Ml2Attribute Copy(string newName) { return new Ml2Attribute(Impl.copy(newName)); }
