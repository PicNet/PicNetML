...
namespace Ml2
{
  public partial class Ml2Evaluation 
  {
  
    /// <summary>
    /// This is used to create a new Runtime with a specified set of Instances.
    /// </summary>
    public Ml2Evaluation(Evaluation impl) { Impl = impl; }
    ...
    public double EvaluateModelOnceAndRecordPrediction(IBaseClassifier<Classifier> classifier, Ml2Instance instance) { return Impl.evaluateModelOnceAndRecordPrediction(classifier.Impl, instance.Impl); }
    public double EvaluateModelOnce(IBaseClassifier<Classifier> classifier, Ml2Instance instance) { return Impl.evaluateModelOnce(classifier.Impl, instance.Impl); }
    public double EvaluateModelOnce(double[] dist, Ml2Instance instance) { return Impl.evaluateModelOnce(dist, instance.Impl); }
    public double EvaluateModelOnceAndRecordPrediction(double[] dist, Ml2Instance instance) { return Impl.evaluateModelOnceAndRecordPrediction(dist, instance.Impl); }
    public void EvaluateModelOnce(double prediction, Ml2Instance instance) { Impl.evaluateModelOnce(prediction, instance.Impl); }
    ...
    public void UpdatePriors(Ml2Instance instance) { Impl.updatePriors(instance.Impl); }
