...
namespace Ml2.Tasks.Generator.Core
{
  ...
  {    
    ...
    private string GetCsWrapperForReturn(MethodInfo mi) { 
      switch (mi.ReturnType.Name) {
        case "Instance": return "Ml2Instance";
        case "Instances": return "Runtime";
        case "Attribute": return "Ml2Attribute";
        default: return null;
      }
    }
    ...
    private string TemplateMethods(string name) {
      switch (name) {
        ...
        case "enumerateAttributes": 
          return "public IEnumerable<Ml2Attribute> EnumerateAttributes { get { return Impl.ToEnumerableAttributes(); } }";
	    case "enumerateValues": 
          return "public IEnumerable<string> EnumerateValues { get { return Impl.ToEnumerable(); } }";
        case "instance" :
          return "public Ml2Instance Instance(int index) { return new Ml2Instance(Impl.instance(index)); }";
        case "remove" :
          return "public Ml2Instance Remove(int index) { return new Ml2Instance(Impl.remove(index)); }";
        case "set" :
          return "public Ml2Instance Set(int index, Ml2Instance instance) { return new Ml2Instance(Impl.set(index, instance.Impl)); }";
        case "get" :
          return "public Ml2Instance Get(int index) { return new Ml2Instance(Impl.get(index)); }";
        case "lastInstance" :
          return "public Ml2Instance LastInstance { get { return new Ml2Instance(Impl.lastInstance()); } }";
        case "firstInstance" :
          return "public Ml2Instance FirstInstance { get { return new Ml2Instance(Impl.firstInstance()); } }";
        default: return null;
      }
    }
  }
