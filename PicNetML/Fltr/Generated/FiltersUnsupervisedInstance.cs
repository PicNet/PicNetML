...
{
  public class FiltersUnsupervisedInstance
  {
    private readonly Runtime rt;    
    public FiltersUnsupervisedInstance(Runtime rt) { this.rt = rt; }   
    ...
    /// </summary>
    public NonSparseToSparse NonSparseToSparse { get {
      return new NonSparseToSparse(rt); 
    } }
    ...
    /// </summary>
    public Randomize Randomize { get {
      return new Randomize(rt); 
    } }
    ...
    /// </summary>
    public RemoveFolds RemoveFolds { get {
      return new RemoveFolds(rt); 
    } }
    ...
    /// </summary>
    public RemoveFrequentValues RemoveFrequentValues { get {
      return new RemoveFrequentValues(rt); 
    } }
    ...
    /// </summary>
    public RemoveMisclassified RemoveMisclassified { get {
      return new RemoveMisclassified(rt); 
    } }
    ...
    /// output.<br/>
    /// </summary>
    public RemovePercentage RemovePercentage { get {
      return new RemovePercentage(rt); 
    } }
    ...
    /// </summary>
    public RemoveRange RemoveRange { get {
      return new RemoveRange(rt); 
    } }
    ...
    /// criteria)
    /// </summary>
    public RemoveWithValues RemoveWithValues { get {
      return new RemoveWithValues(rt); 
    } }
    ...
    /// </summary>
    public ReservoirSample ReservoirSample { get {
      return new ReservoirSample(rt); 
    } }
    ...
    /// non-sparse format.
    /// </summary>
    public SparseToNonSparse SparseToNonSparse { get {
      return new SparseToNonSparse(rt); 
    } }
    ...
    /// return the instance)
    /// </summary>
    public SubsetByExpression SubsetByExpression { get {
      return new SubsetByExpression(rt); 
    } }
