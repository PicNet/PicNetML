...
namespace PicNetML.Clss
{
  ...
  /// </summary>
  public class NaiveBayesUpdateable : BaseClassifier<weka.classifiers.bayes.NaiveBayesUpdateable>
  {
    public NaiveBayesUpdateable(Runtime rt) : base(rt, new weka.classifiers.bayes.NaiveBayesUpdateable()) {
    ...
    /// ones.
    /// </summary>    
    public NaiveBayesUpdateable UseSupervisedDiscretization (bool newblah) {
    ...
    /// distribution.
    /// </summary>    
    public NaiveBayesUpdateable UseKernelEstimator (bool v) {
    ...
    /// and many attributes.
    /// </summary>    
    public NaiveBayesUpdateable DisplayModelInOldFormat (bool d) {
    ...
    /// </summary>    
    public NaiveBayesUpdateable Debug (bool debug) {
      Impl.setDebug(debug);
      return this;
    }
