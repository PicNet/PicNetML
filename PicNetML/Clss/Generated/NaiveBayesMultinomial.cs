...
namespace PicNetML.Clss
{
  ...
  /// info to the console
  /// </summary>
  public class NaiveBayesMultinomial : BaseClassifier<weka.classifiers.bayes.NaiveBayesMultinomial>
  {
    public NaiveBayesMultinomial(Runtime rt) : base(rt, new weka.classifiers.bayes.NaiveBayesMultinomial()) {
    ...
    /// </summary>    
    public NaiveBayesMultinomial Debug (bool debug) {
      Impl.setDebug(debug);
      return this;
    }
