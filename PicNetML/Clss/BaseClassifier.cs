...
namespace PicNetML.Clss
{
  public interface IBaseClassifier<out I> where I : Classifier {
    ...
    double Classify(PmlInstance instance);
    double ClassifyProba(PmlInstance instance);
  ...
  {    
    ...
    public double Classify(PmlInstance instance)
    {
      Build();
      return Impl.classifyInstance(instance.Impl);
    }

    public double ClassifyProba(PmlInstance instance) {
      Build();
